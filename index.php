...
$app->map(['GET', 'POST'], '/answer', function (Request $request, Response $response, array $args) {
    ...
    $twilioResponse->say('Thanks for calling! We just sent you a text. Please follow instructions.', ['voice' => 'alice']);
...
function sendSms($toNumber, $fromNumber) {
    ...
    try {
        $client->messages->create(
            ...
            array(
                'from' => $fromNumber,
                'body' => "Click here for more details https://fasterpermitsplace.com/ .",
            )
        );
